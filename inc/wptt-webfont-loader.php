...
if ( ! class_exists( 'Ayurvedic_Medicine_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Ayurvedic_Medicine_WPTT_WebFont_Loader {
		...
		public function get_remote_url_contents() {
			...
			$ayurvedic_medicine_contents = wp_remote_retrieve_body( $response );

			return $ayurvedic_medicine_contents;
		}
...
if ( ! function_exists( 'ayurvedic_medicine_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function ayurvedic_medicine_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Ayurvedic_Medicine_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'ayurvedic_medicine_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function ayurvedic_medicine_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Ayurvedic_Medicine_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
